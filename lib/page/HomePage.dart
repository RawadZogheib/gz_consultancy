                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Image.asset(
                                'Assets/HomePage/gz_consultancy.jpeg',
                                fit: BoxFit.contain,
                                height: height11,
                                width: 150,
                              ),
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              const Text("Create Web",style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 25
                                              ),),
                                              const SizedBox(
                                              ...
                                              Image.asset('Assets/HomePage/create web.jpg')
                                            ],
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              const Text("Marketing & Sales Training",
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 25,
                                              ),
                                              ...
                                              Image.asset('Assets/HomePage/sale-and-marketing.jpg')
                                            ],
                                          ),
                                        ),
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              const Text("Create & Manage Instagram",
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 23,
                                                ),
                                              ...
                                              Image.asset('Assets/HomePage/insta.png')
                                            ],
                                          ),
                                        ),
                                      ],
